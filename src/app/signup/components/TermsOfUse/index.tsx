...
import { useTermsOfUse } from '@/app/signup/hooks'
import type { FormTermsOfUseFields } from '@/app/signup/types'
import './style.css'

export function TermsOfUse() {
  const { handleSubmit, onSubmit, register } = useTermsOfUse()
  return (
    <div className="cardSign">
      ...
      <div className="content">
        <div className="terms">
          ...
          <b>
            TERMO DE CONSENTIMENTO PARA TRATAMENTO DE DADOS PESSOAIS – LGPD PARA
            PESSOAS FÍSICAS E JURÍDICAS
          </b>

          <p>
            <b>CONTROL 361º TECNOLOGIA E SERVIÇOS LTDA</b> devidamente inscrita
            no CNPJ sob o nº pessoa jurídica de direito privado, inscrita no
            CNPJ/MF de nº 24.867.242/001-45, com sede na Alameda Araguaia, nº
            2044, Conjunto 707, Bloco 1, Alphaville Industrial, cidade de
            Barueri,estado de São Paulo, CEP 06455-906, doravante denominada{' '}
            <b>CONTROLADORA</b>
          </p>

          <p>
            Este termo de consentimento foi elaborado em conformidade com a Lei
            Geral de Proteção de Dados Pessoais - LGPD. Consoante ao artigo 5º
            inciso XII da Lei 13.709, este documento viabiliza a manifestação
            livre, informada e inequívoca, pela qual o titular/ responsável
            concorda com o tratamento de seus dados pessoais e os dados do menor
            sob os seus cuidados, para as finalidades a seguir determinadas:
          </p>
          ...
          <p>
            ...
            <b>CONTROLADORA</b> proceda com o <b>tratamento</b> dos meus dados,
            tanto no site da Contro 361º, como no aplicativo.
          </p>
          ...
          <p>
            O usuário fica ciente de que as informações geradas pelo aplicativo,
            podem ser passíveis de compartilhamentos, e os dados gerados poderão
            ser utilizados por terceiros com sua devida anuência.
          </p>
          ...
          <p>
            ...
            para as empresas realizarem o tratamento, mediante sua autorização.
          </p>
